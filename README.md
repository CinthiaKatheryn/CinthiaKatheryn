# Hola, soy Cinthia Katheryn 👋

Profesional en **Estadística Informática**, con experiencia en **análisis de datos, gestión presupuestaria, inteligencia de negocios, gobernanza de datos y gestión pública**.

Actualmente estoy fortaleciendo mi perfil en **Data Analytics, Business Intelligence, Gobierno de Datos y automatización de procesos**, combinando mi experiencia en el sector público con herramientas tecnológicas para mejorar el análisis, seguimiento y toma de decisiones.
...
Seguir desarrollando un perfil orientado a **analítica de datos, inteligencia de negocios y gobierno de datos**, aplicando mi experiencia en gestión pública y presupuesto para crear soluciones basadas en información confiable, ordenada y útil.
